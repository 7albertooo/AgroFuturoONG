...
<section class="max-w-7xl mx-auto px-4 py-3 flex flex-col items-center min-h-220 md:min-h-215 lg:flex-row justify-center lg:items-center lg:gap-50 gap-10">
